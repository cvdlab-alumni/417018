...
var stair=COLOR([0.94,0.90,0.55])(stairs([-36,0.4],[-1,3],[depthFloor]));
...
var leg=SIMPLEX_GRID([[0.2],[0.2],[-depthFloor,1]]);
var table0=T([0,1])([25,9])(SIMPLEX_GRID([[3.7],[1.7],[-depthFloor-1,0.3]]));
var leg01=T([0,1])([25,9])(leg);
var leg11=T([0,1])([28.5,9])(leg);
var leg21=T([0,1])([25,10.5])(leg);
var leg31=T([0,1])([28.5,10.5])(leg);
var table=STRUCT([table0,leg01,leg11,leg21,leg31]);
var table1=T([0,1])([15,12])(SIMPLEX_GRID([[3.7],[1.7],[-depthFloor-1,0.3]]));
var l0=T([0,1])([15,12])(leg);
var l1=T([0,1])([18.5,12])(leg);
var l2=T([0,1])([15,13.5])(leg);
var l3=T([0,1])([18.5,13.5])(leg);
var table00=STRUCT([table1,l0,l1,l2,l3]);
var table01=COLOR([0.55,0.27,0.075])(STRUCT([table,table00]));
var floor=COLOR([0.94,0.90,0.55])(STRUCT([floor0,floor1,floor2,floor3,floor4,floor5,floor6,floor7,floor8,floor9,floor10]));
var construction=STRUCT([floor,stair,walls,pools,columns,glassWindow,roof,bench,table01]);
DRAW(construction);
